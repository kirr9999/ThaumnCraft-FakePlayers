...
public class EntityExplosiveOrb extends EntityThrowable
{
	...
	protected void onImpact(MovingObjectPosition mop)
	{
		if (!this.worldObj.isRemote)
		{
			...
			if (mop.entityHit != null && !EventUtils.cantDamage(FastUtils.getThrower(this, ModUtils.profile), mop.entityHit))
			...
			ExplosionByPlayer.newExplosion(FastUtils.getThrowerPlayer(this, ModUtils.profile), this.worldObj, null, this.posX, this.posY, this.posZ, this.strength, this.onFire, false);
			this.setDead();
		}
