...
public class TileHole extends TileMemory
{
	...
	public void updateEntity()
	{
		...
		if (this.countdown == 0 && this.count > 1 && this.direction != -1)
		{
			...
			label85: switch (this.direction)
			{
				...
				case 1:
					...
					while (true)
					{
						...
						if (a / 3 != 1 || a % 3 != 1)
							...
							ItemFocusPortableHole.createHole(this.fake.getPlayer(), this.worldObj, ii - 1 + a / 3, jj, kk - 1 + a % 3, -1, (byte) 1, this.countdownmax);
				...
				case 3:
					...
					while (true)
					{
						...
						if (a / 3 != 1 || a % 3 != 1)
							// TODO gamerforEA add EntityPlayer parameter
							ItemFocusPortableHole.createHole(this.fake.getPlayer(), this.worldObj, ii - 1 + a / 3, jj - 1 + a % 3, kk, -1, (byte) 1, this.countdownmax);
				...
				case 5:
					for (a = 0; a < 9; ++a)
						if (a / 3 != 1 || a % 3 != 1)
							// TODO gamerforEA add EntityPlayer parameter
							ItemFocusPortableHole.createHole(this.fake.getPlayer(), this.worldObj, ii, jj - 1 + a / 3, kk - 1 + a % 3, -1, (byte) 1, this.countdownmax);
			}
			...
			// TODO gamerforEA add EntityPlayer parameter
			if (!ItemFocusPortableHole.createHole(this.fake.getPlayer(), this.worldObj, ii, jj, kk, this.direction, (byte) (this.count - 1), this.countdownmax))
				this.count = 0;
		}
